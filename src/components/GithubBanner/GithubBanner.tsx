// src/components/GithubBanner/GithubBanner.tsx
import Link from 'next/link';
import styles from './GithubBanner.module.css';
import GithubCalendarClient from './GithubCalendarClient'; // <-- Importamos a fronteira

export default function GithubBanner() {
  return (
    <Link 
      href="https://github.com/jo4ocarlos" 
      target="_blank"
    ...
    >
      ...
      <div className={styles.textWrapper}>
        ...
        <p className={styles.subtitle}>
          Explore meus repositórios e atualizações recentes.
        </p>
      </div>
